  ...
  return (
    ...
    >
      ...
      <g transform="translate(0,12)">
        ...
        <rect x="10" y="106" width="34" height="14" rx="3" fill="rgba(94,231,223,0.6)" />
      </g>

      {/* M3 — rounded surface card */}
      <g transform="translate(98,12)">
        <rect x="0" y="0" width="92" height="128" rx="20" fill="rgba(180,144,245,0.1)" stroke="rgba(180,144,245,0.2)" />
        <rect x="12" y="12" width="68" height="36" rx="14" fill="rgba(180,144,245,0.22)" />
        ...
        <circle cx="22" cy="100" r="10" fill="rgba(180,144,245,0.6)" />
        <rect x="38" y="92" width="42" height="18" rx="9" fill="rgba(180,144,245,0.32)" />
      </g>

      {/* Fluent — compound input */}
      <g transform="translate(194,12)">
        <rect x="0" y="0" width="92" height="128" rx="6" fill="rgba(94,180,255,0.08)" stroke="rgba(94,180,255,0.18)" />
        ...
        <rect x="12" y="50" width="68" height="2" fill="rgba(94,180,255,0.7)" />
        ...
        <rect x="12" y="98" width="68" height="2" fill="rgba(94,180,255,0.45)" />
        <rect x="12" y="108" width="38" height="14" rx="3" fill="rgba(94,180,255,0.55)" />
      </g>
      ...
      <g transform="translate(290,12)">
        ...
        <rect x="74" y="6" width="14" height="10" rx="0" fill="rgba(15,98,254,1)" />
        ...
        <rect x="10" y="114" width="28" height="10" rx="0" fill="rgba(15,98,254,0.92)" />
      </g>

      {/* ausos — glass panel */}
      <g transform="translate(386,12)">
        <rect x="0" y="0" width="92" height="128" rx="14" fill="rgba(197,244,222,0.06)" stroke="rgba(197,244,222,0.18)" />
        <rect x="12" y="14" width="68" height="22" rx="11" fill="rgba(197,244,222,0.12)" stroke="rgba(255,255,255,0.16)" />
        <rect x="22" y="22" width="6" height="6" rx="3" fill="rgba(94,231,223,0.85)" />
        ...
        <rect x="12" y="86" width="32" height="14" rx="7" fill="rgba(94,231,223,0.42)" />
        <rect x="48" y="86" width="32" height="14" rx="7" fill="rgba(255,255,255,0.06)" stroke="rgba(255,255,255,0.16)" />
        <circle cx="20" cy="116" r="4" fill="rgba(94,231,223,0.85)" />
  ...
  return (
    ...
    >
      ...
      <g transform="translate(8,12)">
        ...
        <rect x="74" y="22" width="138" height="44" rx="3" fill="rgba(94,231,223,0.16)" stroke="rgba(94,231,223,0.32)" />
      ...
      <g transform="translate(244,18)">
        ...
        <rect x="8" y="20" width="104" height="22" rx="3" fill="rgba(180,144,245,0.16)" stroke="rgba(180,144,245,0.32)" />
        ...
        <rect x="8" y="114" width="64" height="6" rx="2" fill="rgba(180,144,245,0.5)" />
      </g>
      ...
      <g transform="translate(388,12)">
        ...
        <rect x="6" y="14" width="62" height="22" rx="4" fill="rgba(94,180,255,0.18)" stroke="rgba(94,180,255,0.34)" />
        ...
        <rect x="6" y="106" width="62" height="20" rx="10" fill="rgba(94,180,255,0.55)" />
      </g>
    </svg>
  );
}
  ...
  return (
    ...
    >
      ...
      <g transform="translate(20,16)">
        <rect x="0" y="0" width="138" height="128" rx="10" fill="rgba(94,180,255,0.08)" stroke="rgba(94,180,255,0.22)" />
        <g transform="translate(69,52)" stroke="rgba(94,180,255,0.85)" strokeWidth="1.6" fill="none">
          <ellipse cx="0" cy="0" rx="32" ry="12" />
          <ellipse cx="0" cy="0" rx="32" ry="12" transform="rotate(60)" />
          <ellipse cx="0" cy="0" rx="32" ry="12" transform="rotate(-60)" />
          <circle cx="0" cy="0" r="4" fill="rgba(94,180,255,1)" stroke="none" />
        </g>
        <rect x="42" y="100" width="54" height="6" rx="2" fill="rgba(94,180,255,0.85)" />
        <rect x="48" y="112" width="42" height="3" rx="1" fill="rgba(255,255,255,0.4)" />
      </g>

      {/* HTML card — angle brackets */}
      <g transform="translate(170,16)">
        <rect x="0" y="0" width="138" height="128" rx="10" fill="rgba(247,138,184,0.08)" stroke="rgba(247,138,184,0.22)" />
        <g transform="translate(69,52)" stroke="rgba(247,138,184,0.92)" strokeWidth="3" fill="none" strokeLinecap="round" strokeLinejoin="round">
          <polyline points="-22,-14 -38,0 -22,14" />
          <polyline points="22,-14 38,0 22,14" />
          <line x1="-8" y1="16" x2="8" y2="-16" stroke="rgba(255,255,255,0.55)" strokeWidth="2.4" />
        </g>
        <rect x="42" y="100" width="54" height="6" rx="2" fill="rgba(247,138,184,0.85)" />
        <rect x="48" y="112" width="42" height="3" rx="1" fill="rgba(255,255,255,0.4)" />
      </g>

      {/* Vite card — lightning bolt */}
      <g transform="translate(322,16)">
        <rect x="0" y="0" width="138" height="128" rx="10" fill="rgba(255,173,92,0.08)" stroke="rgba(255,173,92,0.22)" />
        <g transform="translate(69,52)">
          <path
            d="M -10 -28 L 14 -28 L 4 -4 L 18 -4 L -10 30 L 0 4 L -14 4 Z"
            fill="rgba(255,173,92,0.92)"
            stroke="rgba(255,255,255,0.32)"
            strokeWidth="0.8"
          />
        </g>
        <rect x="42" y="100" width="54" height="6" rx="2" fill="rgba(255,173,92,0.92)" />
        <rect x="48" y="112" width="42" height="3" rx="1" fill="rgba(255,255,255,0.4)" />
      </g>
    </svg>
  );
  ...
  return (
    ...
    >
      ...
      <g transform="translate(20,12)">
        ...
        <rect x="20" y="22" width="56" height="14" rx="3" fill="rgba(94,231,223,0.22)" stroke="rgba(94,231,223,0.42)" />
        ...
        <rect x="30" y="92" width="36" height="14" rx="3" fill="rgba(94,231,223,0.45)" />
        <rect x="72" y="92" width="36" height="14" rx="3" fill="rgba(255,255,255,0.06)" stroke="rgba(255,255,255,0.16)" />

        {/* Notes side panel */}
        <rect x="276" y="50" width="148" height="76" rx="4" fill="rgba(180,144,245,0.08)" stroke="rgba(180,144,245,0.22)" />
        <rect x="284" y="60" width="50" height="5" rx="1" fill="rgba(180,144,245,0.85)" />
        ...
        <circle cx="288" cy="116" r="4" fill="rgba(180,144,245,0.85)" />
        <rect x="298" y="113" width="80" height="6" rx="2" fill="rgba(255,255,255,0.32)" />

        {/* Annotation pin on canvas */}
        <g transform="translate(160,82)">
          <circle r="11" fill="rgba(94,231,223,0.92)" stroke="rgba(255,255,255,0.5)" strokeWidth="1" />
