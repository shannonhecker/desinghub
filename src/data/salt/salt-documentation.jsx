...
const COMPS = [
  ...
  {id:"buttons",name:"Buttons",cat:"Actions",desc:"3 appearances: solid, bordered, transparent. 5 sentiments: accented, neutral, positive, caution, negative. States: Default, Hover, Active, Disabled, Loading, Focus.",render:Buttons},
  {id:"pills",name:"Pills / Tags",cat:"Actions",desc:"Toggle selection. Accent fill when active. Used for filters, categories, skills.",render:PillsDemo},
  {id:"inputs",name:"Text Input",cat:"Inputs",desc:"Bottom-border accent on focus. Salt's signature flat-top input with strong baseline.",render:Inputs},
  {id:"checkboxes",name:"Checkbox",cat:"Inputs",desc:"Accent fill when checked. Accessible with role='checkbox' and keyboard support.",render:Checkboxes},
  {id:"radios",name:"Radio Buttons",cat:"Inputs",desc:"Single selection with accent ring + inner dot. Arrow key navigation within group.",render:Radios},
  {id:"switches",name:"Switch",cat:"Inputs",desc:"Toggle on/off. Accent track when on. Thumb slides with decelerate easing.",render:Switches},
  {id:"slider",name:"Slider",cat:"Inputs",desc:"Range input with accent color. Drag to select value.",render:SliderDemo},
  {id:"cards",name:"Cards",cat:"Containment",desc:"Hover lifts with shadow. Gradient header. Outline border + background shift.",render:SaltCards},
  {id:"tabs",name:"Tabs",cat:"Navigation",desc:"Underline-style. Active shows accent underline + semibold. Content switches.",render:TabsComp},
  {id:"banners",name:"Banners",cat:"Communication",desc:"Info (blue), Positive (green), Caution (orange), Negative (red). Left accent border.",render:Banners},
  {id:"dialog",name:"Dialog",cat:"Communication",desc:"Floating modal with shadow-300. Title, body, action buttons. Financial confirmation pattern.",render:DialogDemo},
  {id:"badges",name:"Badges",cat:"Communication",desc:"Accent, negative, positive, caution, and dot variants. Pill-shaped counters.",render:Badges},
  {id:"avatars",name:"Avatars",cat:"Communication",desc:"Circular initials. Multiple sizes. Accent, blue, purple, red backgrounds.",render:Avatars},
  {id:"tooltips",name:"Tooltips",cat:"Communication",desc:"Hover-triggered. Inverted background. Fade-in transition.",render:Tooltips},
  {id:"progress",name:"Progress",cat:"Communication",desc:"Linear bar (4px) + circular spinner. Accent-colored. Determinate + indeterminate.",render:ProgressDemo},
  {id:"accordion",name:"Accordion",cat:"Containment",desc:"Expandable sections. Single open at a time. Chevron indicator rotates.",render:AccordionDemo},
  {id:"dividers",name:"Dividers",cat:"Containment",desc:"1px border line. Full-width and inset variants.",render:Dividers},
  {id:"form-field",name:"Form Field",cat:"Inputs",desc:"Wraps inputs with label, helper text, validation, necessity indicator. States: Default, Hover, Active, Read-only, Disabled, Error.",render:FormField},
  {id:"link",name:"Link",cat:"Navigation",desc:"3 variants: Accent, Primary, Secondary. States: Default, Hover, Active, Visited. Optional trailing icon.",render:LinkDemo},
  ...
  {id:"list-box",name:"List Box",cat:"Inputs",desc:"Single/multi-select list. Optional border. Keyboard nav. Used inside ComboBox, Dropdown.",render:ListBoxDemo},
  {id:"calendar",name:"Calendar",cat:"Inputs",desc:"Composable: CalendarNavigation + CalendarWeekHeader + CalendarGrid. Modes: Single, Range, Multiselect, Offset. Day states: Selected, Range, Today, Unselectable, Disabled.",render:CalendarDemo},
  {id:"date-picker",name:"Date Picker",cat:"Inputs",desc:"Composable: DatePicker > DatePickerSingleInput + DatePickerOverlay + DatePickerSinglePanel + DatePickerActions. Single/range. Requires LocalizationProvider. lab (RC).",render:DatePickerDemo},
  {id:"stepper",name:"Stepper",cat:"Navigation",desc:"Horizontal/vertical progress steps. Active, Completed, Pending, Error states.",render:StepperDemo},
  {id:"pagination",name:"Pagination",cat:"Navigation",desc:"Page navigation with prev/next. Truncation for large counts. Compact mode.",render:PaginationDemo},
  {id:"panel",name:"Panel",cat:"Containment",desc:"Contained section with optional header/close button.",render:PanelDemo},
  {id:"data-grid",name:"Data Grid",cat:"Containment",desc:"Primary/Secondary/Zebra fill. Column groups, multi-select, filter bar, sorting.",render:DataGridDemo},
  {id:"table",name:"Table",cat:"Containment",desc:"Semantic HTML table. Simpler than Data Grid. Column alignment, zebra striping.",render:TableDemo},
  {id:"vert-nav",name:"Vertical Navigation",cat:"Navigation",desc:"Sidebar navigation with active indicator. Supports nesting, icons, badges.",render:VerticalNavDemo},
  {id:"overlay",name:"Overlay / Scrim",cat:"Containment",desc:"Overlay positions content above page. Scrim is semi-transparent backdrop.",render:OverlayScrimDemo},
  {id:"file-drop",name:"File Drop Zone",cat:"Inputs",desc:"Upload by click or drag-drop. States: Default, Drag-drop, Error, Success, Disabled.",render:FileDropZoneDemo},
  {id:"splitter",name:"Splitter",cat:"Containment",desc:"Drag handle to resize panes. Horizontal/vertical. Collapse to minimum.",render:SplitterDemo},
  {id:"skip-link",name:"Skip Link",cat:"Navigation",desc:"Keyboard-only link on Tab focus. Jumps past navigation. WCAG 2.4.1.",render:SkipLinkDemo},
  {id:"nav-item",name:"Navigation Item",cat:"Navigation",desc:"Horizontal/vertical nav items with active indicator. Icons, badges, nesting.",render:NavigationItemDemo},
  {id:"static-list",name:"Static List",cat:"Containment",desc:"Non-interactive display list. Icons, status indicators.",render:StaticListDemo},
  {id:"carousel",name:"Carousel",cat:"Containment",desc:"Slides with progress dots, autoplay, counter. Bordered/transparent.",render:CarouselDemo},
  {id:"combo-box",name:"ComboBox",cat:"Inputs",desc:"Filterable dropdown. Variants: primary/secondary/tertiary. bordered prop. Keyboard nav. Multi-select available.",render:ComboBoxDemo},
  {id:"dropdown",name:"Dropdown",cat:"Inputs",desc:"Select from predefined options. Variants: primary/secondary/tertiary. bordered prop. ValidationStatus support.",render:DropdownDemo},
  {id:"number-input",name:"Number Input",cat:"Inputs",desc:"Increment/decrement stepper buttons. Variants: primary/secondary/tertiary. bordered, min, max, step props.",render:NumberInputDemo},
  {id:"multiline-input",name:"Multiline Input",cat:"Inputs",desc:"Resizable text area. Same variant/bordered/validation API as Input. rows prop.",render:MultilineInputDemo},
  {id:"interactable-card",name:"Interactable Card",cat:"Containment",desc:"Clickable card with selection. Variants: primary/secondary/tertiary. Hover lift + focus ring.",render:InteractableCardDemo},
  {id:"collapsible",name:"Collapsible",cat:"Containment",desc:"Controlled open/close container. Used internally by Accordion. CSS transition. open prop.",render:CollapsibleDemo},
];
