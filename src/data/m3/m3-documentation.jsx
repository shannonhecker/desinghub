...
const COMPS = [
  { id: "buttons", name: "Buttons", cat: "Actions", desc: "Hover, focus (Tab), press, and disabled states all respond to real interaction.", render: Buttons },
  { id: "text-fields", name: "Text Fields", cat: "Inputs", desc: "Click to focus (border thickens + turns primary, label floats). Hover for state layer. Type to see input. Error variant has red border + icon.", render: TextFields },
  { id: "chips", name: "Chips", cat: "Actions", desc: "Click to toggle selected (fill + checkmark). Hover and focus-visible states via CSS.", render: Chips },
  { id: "cards", name: "Cards", cat: "Containment", desc: "Hover raises elevation. Focus-visible shows outline. Active shows pressed state layer.", render: Cards },
  { id: "switches", name: "Switches", cat: "Inputs", desc: "Click to toggle. Thumb resizes: 16dp→24dp on hover→28dp on press. State layer circle appears.", render: Switches },
  { id: "checkboxes", name: "Checkboxes", cat: "Inputs", desc: "Click or Space to toggle. Hover shows state layer. Focus-visible shows outline.", render: Checkboxes },
  { id: "radios", name: "Radio Buttons", cat: "Inputs", desc: "Click to select. Hover shows 40dp state layer circle. One selection at a time.", render: Radios },
  { id: "sliders", name: "Sliders", cat: "Inputs", desc: "Drag thumb or click track. Thumb scales up on hover and press.", render: Sliders },
  { id: "fabs", name: "FAB", cat: "Actions", desc: "Hover raises elevation (Level 3→4). State layers on press. Focus-visible ring.", render: Fabs },
  { id: "icon-buttons", name: "Icon Buttons", cat: "Actions", desc: "Click to toggle selected. 4 variants with different fill behaviors. Hover/press state layers.", render: IconButtons },
  { id: "nav-bar", name: "Navigation Bar", cat: "Navigation", desc: "Click items. Active shows 64dp pill indicator. Hover shows state layer on pill.", render: NavBar },
  { id: "tabs", name: "Tabs", cat: "Navigation", desc: "Click to switch. Hover shows primary state layer. Active shows indicator bar.", render: TabsComp },
  { id: "dialogs", name: "Dialogs", cat: "Communication", desc: "Action buttons respond to hover/focus/press. Dialog container at Level 3 elevation.", render: Dialog },
  { id: "snackbar", name: "Snackbar", cat: "Communication", desc: "Action and close buttons respond to hover/focus.", render: Snackbars },
  { id: "progress", name: "Progress Indicators", cat: "Communication", desc: "Animated linear and circular indicators. Determinate fills in real-time.", render: Progress },
  { id: "tooltips", name: "Tooltips", cat: "Communication", desc: "Hover or focus the icon buttons to see tooltips appear.", render: Tooltips },
  { id: "badges", name: "Badges", cat: "Communication", desc: "Dot and count badges anchored to interactive icon buttons.", render: Badges },
  { id: "menus", name: "Menus", cat: "Actions", desc: "Hover and focus-visible highlights on menu items. Tab through items.", render: Menu },
  { id: "bottom-sheets", name: "Bottom Sheets", cat: "Containment", desc: "Drag handle and content layout.", render: BottomSheet },
  { id: "dividers", name: "Dividers", cat: "Containment", desc: "Full-width and inset dividers.", render: Dividers },
  { id: "date-pickers", name: "Date Pickers", cat: "Inputs", desc: "Click days to select. Hover shows surface overlay. Focus-visible shows ring. Nav buttons interactive.", render: DatePicker },
  // Foundations
  ...
  // Guides
  { id: "guide-color-roles", name: "Color Roles", cat: "Guides", desc: "Primary, Secondary, Tertiary, Error — what each accent color group is for and where to use it.", render: ColorRolesGuide },
  { id: "guide-surfaces", name: "Surfaces & Depth", cat: "Guides", desc: "Surface container scale, outline tokens, and inverse colors for building visual hierarchy.", render: SurfaceGuide },
  { id: "guide-state-layers", name: "State Layers", cat: "Guides", desc: "Hover (8%), Focus (12%), Pressed (12%), Dragged (16%) — how to apply interactive overlays.", render: StateLayers },
  { id: "guide-theming", name: "Theming Principles", cat: "Guides", desc: "HCT color space, tonal palettes, dark theme rules, dynamic color, and accessible pairing rules.", render: ThemingGuide },
  { id: "guide-mapping", name: "Component Mapping", cat: "Guides", desc: "Which color token maps to which component — container, content, and state layer assignments.", render: ColorMappingGuide },
  { id: "guide-palette", name: "Full Palette", cat: "Guides", desc: "All tokens in the current theme visualized. Switch themes to compare values side by side.", render: FullPalettePreview },
];
const CATS = ["Guides", "Foundations", "Actions", "Inputs", "Navigation", "Communication", "Containment"];
