...
export function fluentColorVars(T: any): string {
  return [
    ...
    `--colorNeutralBackground1Hover: ${T.subtleBgHover};`,
    `--colorNeutralBackground1Pressed: ${T.subtleBgPressed};`,
    `--colorNeutralBackground1Selected: ${T.subtleBgSelected};`,
    ...
    /* Transparent-appearance state tokens — used by Tab (default appearance),
       transparent buttons, and other surfaces that overlay without a fill at
       rest. Hover/Pressed/Selected provide a subtle wash that matches the
       canonical Fluent UI v9 useTab styles. */
    `--colorTransparentBackground: transparent;`,
    `--colorTransparentBackgroundHover: ${T.subtleBgHover};`,
    `--colorTransparentBackgroundPressed: ${T.subtleBgPressed};`,
    `--colorTransparentBackgroundSelected: ${T.subtleBgSelected};`,
    ...
    `--colorNeutralForeground1Hover: ${T.fg1};`,
    `--colorNeutralForeground1Pressed: ${T.fg1};`,
    `--colorNeutralForeground1Selected: ${T.fg1};`,
    `--colorNeutralForeground2: ${T.fg2};`,
    `--colorNeutralForeground2Hover: ${T.fg1};`,
    `--colorNeutralForeground2Pressed: ${T.fg1};`,
    `--colorNeutralForeground2Selected: ${T.fg1};`,
    ...
    /* Compound brand tokens — Fluent v9's selected-tab indicator and other
       brand-emphasis affordances use these (slightly more saturated than
       the base brand foreground/stroke). */
    `--colorCompoundBrandForeground1: ${T.brandFg1};`,
    `--colorCompoundBrandForeground1Hover: ${T.brandFg2};`,
    `--colorCompoundBrandForeground1Pressed: ${T.brandFg2};`,
    `--colorCompoundBrandStroke: ${T.brandStroke1};`,
    `--colorCompoundBrandStrokeHover: ${T.brandStroke1};`,
    `--colorCompoundBrandStrokePressed: ${T.brandStroke1};`,
